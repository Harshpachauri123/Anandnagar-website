...
const complaintCategories = [
  {
    value: "Sanitation",
    label: "Sanitation / Garbage Dumping",
  },
  {
    value: "Water Supply",
  ...
  {
    value: "Roads",
    label: "Potholes / Damaged Roadways",
  },
  {
    value: "Streetlights",
    label: "Street Lights Malfunction",
  },
  {
    value: "Encroachments",
...
export default function PublicGrievance() {
  ...
  const resetMessages = () => {
    ...
    if (
      createGrievanceMutation.isError ||
      createGrievanceMutation.isSuccess
    ) {
  ...
  const handleInputChange = (
    ...
    const fieldName =
      name as keyof CreateGrievanceData
  ...
  const handleSubmit = (
    ...
    const validation =
      createGrievanceSchema.safeParse(formData)

    if (!validation.success) {
      setValidationError(
        validation.error.issues[0]?.message ??
          "Please enter valid grievance details.",
      )
    ...
    createGrievanceMutation.mutate(
      validation.data,
      {
        onSuccess: (createdGrievance) => {
          const trackingCode =
            `ANANDNAGAR-GRV-${String(
              createdGrievance.id,
            ).padStart(6, "0")}`

          setComplaintId(trackingCode)
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                Nagar Panchayat Anandnagar is committed
                to providing a transparent and responsive
                grievance redressal system for citizens.
                Register civic complaints and help us
                improve services across Anandnagar.
              </p>
                ...
                <div className="relative overflow-hidden rounded-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <p className="mt-1 text-xs text-slate-300">
                      Every submitted grievance receives a
        ...
        <div className="mx-auto w-full max-w-[1200px]">
          ...
          <div className="mb-8 max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-500">
              ...
              your complaint can be reviewed and forwarded
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-500">
                    Please provide complete and accurate
              ...
              <AnimatePresence mode="wait">
                ...
                {submitted ? (
                  ...
                  <m.div
                    ...
                    className="mx-auto flex max-w-lg flex-col items-center justify-center py-10 text-center"
                  >

                    <div className="flex h-20 w-20 items-center justify-center rounded-full border border-emerald-100 bg-emerald-50 text-emerald-600 shadow-sm">

                      <CheckCircle2 className="h-10 w-10" />

                    </div>

                    <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1.5 text-[9px] font-bold uppercase tracking-wider text-emerald-700">
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      ...
                      successfully submitted to Nagar
                    ...
                    <div className="mt-6 w-full rounded-2xl border border-slate-200 bg-slate-50 p-5">

                      <p className="text-[9px] font-bold uppercase tracking-[0.14em] text-slate-400">
                        Your Tracking Reference
                      </p>

                      <p className="mt-2 break-all font-mono text-lg font-black tracking-wider text-slate-900">
                        {complaintId}
                      </p>
                    ...
                    <Button
                      ...
                      className="mt-7 cursor-pointer rounded-xl border-slate-200 px-5 py-2.5 text-xs font-bold transition-colors hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700"
                    >
                  ...
                  >
                    ...
                    {createGrievanceMutation.isError && (
                      ...
                      >
                        ...
                        <span>
                          {createGrievanceMutation.error instanceof
                          Error
                            ? createGrievanceMutation.error.message
                    ...
                    <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-[11px] leading-5 text-amber-800">
                          ...
                          Your grievance reference will be
                          recorded for official review and
                          monitoring.
                        </p>
                    ...
                    <div className="flex flex-col-reverse gap-3 border-t border-slate-100 pt-6 sm:flex-row sm:items-center sm:justify-end">
                      ...
                      <Button
                        ...
                        className="group h-11 cursor-pointer rounded-xl bg-blue-600 px-6 text-xs font-bold text-white shadow-md shadow-blue-600/10 transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-700 hover:shadow-lg focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
                      >
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-md">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Your submitted information is recorded
                through the official grievance system.
              </p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                A unique tracking reference is generated
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-md">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Select your Anandnagar ward for accurate
